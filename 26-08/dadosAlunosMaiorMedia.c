...
Objetivo: Ler os dados de alunos e armazená-los em um vetor de estruturas, para em seguida imprimir as informações, o IRA médio e
numero de alunos com IRA maior que a media
*******************************************************************************/
#include <stdio.h>
#include <string.h>
